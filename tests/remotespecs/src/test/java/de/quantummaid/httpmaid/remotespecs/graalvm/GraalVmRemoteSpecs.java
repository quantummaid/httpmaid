...
import static de.quantummaid.httpmaid.remotespecs.graalvm.GraalVmDeployer.graalVmDeployer;

@ExtendWith(RemoteSpecsExtension.class)
public final class GraalVmRemoteSpecs implements RemoteSpecs {

    @Override
    public RemoteSpecsDeployer provideDeployer() {
        return graalVmDeployer();
    }
}
