...
import static de.quantummaid.httpmaid.remotespecs.lambda.aws.cloudformation.synthesizer.modules.FunctionModule.graalVmCognitoAuthorizedFunctionModule;
...
public final class GraalVmCognitoHttpApiV1PayloadRemoteSpecs implements RemoteSpecs {
    ...
    public static CloudformationModule infrastructureRequirements(final Namespace namespace,
        ...
        return builder -> {
            ...
            final FunctionModule functionModule = graalVmCognitoAuthorizedFunctionModule(namespace, artifact, Map.of(
