...
import static de.quantummaid.httpmaid.remotespecs.lambda.aws.cloudformation.synthesizer.modules.FunctionModule.graalVmUnauthorizedFunctionModule;
...
public final class GraalVmUnauthHttpApiV2PayloadRemoteSpecs implements RemoteSpecs {
    ...
    public static CloudformationModule infrastructureRequirements(final Namespace namespace,
        ...
        return builder -> {
            ...
            final FunctionModule functionModule = graalVmUnauthorizedFunctionModule(namespace, artifact, Map.of(
