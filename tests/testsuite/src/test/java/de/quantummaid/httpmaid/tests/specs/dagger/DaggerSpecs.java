...
package de.quantummaid.httpmaid.tests.specs.dagger;

import de.quantummaid.httpmaid.tests.givenwhenthen.TestEnvironment;
import de.quantummaid.httpmaid.tests.specs.dagger.domain.DaggerUseCase;
...
public final class DaggerSpecs {
    ...
    public void daggerIntegrationWorks(final TestEnvironment testEnvironment) {
        testEnvironment.given(
                anHttpMaid()
                        .get("/", DaggerUseCase.class)
                        .configured(toCreateUseCaseInstancesUsingDagger())
                        .build()
        )
