...
public final class FakeHttpApiGatewayV1PayloadWithWsAuthDeployer implements Deployer {
    ...
    public static Deployer fakeHttpApiGatewayV1PayloadWithWsAuthDeployer() {
        return new FakeHttpApiGatewayV1PayloadWithWsAuthDeployer();
    }
    ...
    public String toString() {
        return "apiGatewayV1PayloadWsAuth";
    }
