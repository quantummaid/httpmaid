...
public final class FakeRestApiGatewayWithWsAuthorizationDeployer implements Deployer {
    ...
    public static Deployer fakeRestApiGatewayWithWsAuthorizationDeployer() {
        return new FakeRestApiGatewayWithWsAuthorizationDeployer();
    }
    ...
    public Deployment deploy(final HttpMaid httpMaid) {
        ...
        currentWebsocketLambda = fakeWebsocketLambda(awsWebsocketLambdaEndpoint, authorizer, websocketsPort, apiWebsockets);
