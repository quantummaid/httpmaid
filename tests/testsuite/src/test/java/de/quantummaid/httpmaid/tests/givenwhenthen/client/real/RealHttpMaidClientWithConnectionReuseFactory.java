...
public final class RealHttpMaidClientWithConnectionReuseFactory implements ClientFactory {

    public static ClientFactory theRealHttpMaidClientWithConnectionReuse() {
        return new RealHttpMaidClientWithConnectionReuseFactory();
    }
    ...
    public String toString() {
        return "httpmaidclientwithreuse";
    }
}
