...
public final class FakeHttpApiGatewayV2PayloadWithWsAuthDeployer implements Deployer {
    ...
    public static Deployer fakeHttpApiGatewayV2PayloadWithWsAuthDeployer() {
        return new FakeHttpApiGatewayV2PayloadWithWsAuthDeployer();
    }
    ...
    public String toString() {
        return "apiGatewayV2PayloadWsAuth";
    }
