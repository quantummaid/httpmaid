...
package de.quantummaid.httpmaid.tests.givenwhenthen.deploy.awslambda;
...
import static de.quantummaid.httpmaid.tests.givenwhenthen.deploy.awslambda.Poller.sleep;
import static de.quantummaid.httpmaid.tests.givenwhenthen.deploy.awslambda.Poller.waitFor;
import static de.quantummaid.httpmaid.tests.givenwhenthen.deploy.awslambda.S3Handler.deleteFromS3Bucket;
import static de.quantummaid.httpmaid.tests.givenwhenthen.deploy.awslambda.S3Handler.uploadToS3Bucket;
import static de.quantummaid.httpmaid.tests.givenwhenthen.deploy.awslambda.lambdastatus.LambdaStatus.isReady;
