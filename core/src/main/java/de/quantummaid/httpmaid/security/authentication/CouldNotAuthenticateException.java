...
public final class CouldNotAuthenticateException extends RuntimeException {
    ...
    private CouldNotAuthenticateException(final String message, final AuthenticatorId authenticatorId) {
        super(message);
        this.authenticatorId = authenticatorId;
    }

    public static CouldNotAuthenticateException couldNotAuthenticateException(final MetaData metaData,
