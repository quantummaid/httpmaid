...
public final class MetricsProvider<T> {
    ...
    public static <T> MetricsProvider<T> metricsProvider(final MetaDataKey<T> key,
                                                         final MetaData metaData) {
        Validators.validateNotNull(key, "key");
        Validators.validateNotNull(metaData, "metaData");
        return new MetricsProvider<>(key, metaData);
    }

    public void provideMetric(final T value) {
