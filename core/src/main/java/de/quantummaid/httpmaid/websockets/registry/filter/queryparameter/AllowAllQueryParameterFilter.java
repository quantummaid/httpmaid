...
public final class AllowAllQueryParameterFilter implements QueryParameterFilter {

    public static QueryParameterFilter allowAllQueryParameterFilter() {
        return new AllowAllQueryParameterFilter();
    }
