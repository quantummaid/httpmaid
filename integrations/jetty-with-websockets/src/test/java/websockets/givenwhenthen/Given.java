...
public final class Given {
    ...
    public static Given given(final HttpMaid httpMaid) {
        final TestConfiguration testConfiguration = testConfiguration(httpMaid);
    ...
    public When when() {
        ...
        jettyEndpointWithWebSocketsSupportFor(testConfiguration.httpMaid()).listeningOnThePort(port);
