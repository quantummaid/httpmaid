...
public final class ReportBuilder {
    ...
    @Getter
    private final List<Exception> exceptionsDuringWebSocketConnecting = new LinkedList<>();
    @Setter
    @Getter
    private String normalResponseBody;
    @Setter
    @Getter
    private Integer numberOfActiveWebSockets;
