...
public final class When {
    ...
    public HeadersStage aNormalGETRequestIsIssuedToThePath(final String path) {
        return headers -> {
            ...
            final String response = httpMaidClient.issue(builder.mappedTo(String.class));
    ...
    public WhenOrThen theNumberOfActiveWebSocketsIsQueried() {
        final int numberOfActiveWebSockets = testConfiguration.httpMaid().getMetaDatum(NUMBER_OF_ACTIVE_WEB_SOCKETS);
