...
public final class ProvidedInjectorInstantiatorFactory implements UseCaseInstantiatorFactory {
    private final Injector injector;

    public static UseCaseInstantiatorFactory providedInjectorInstantiatorFactory(final Injector injector) {
        return new ProvidedInjectorInstantiatorFactory(injector);
    }
