...
public final class IncomingEventMapping {
    ...
    static IncomingEventMapping incomingEventMapping(final EventType eventType, final WebSocketForEventFilter filter) {
        validateNotNull(eventType, "eventType");
        validateNotNull(filter, "filter");
        return new IncomingEventMapping(eventType, filter);
    }
