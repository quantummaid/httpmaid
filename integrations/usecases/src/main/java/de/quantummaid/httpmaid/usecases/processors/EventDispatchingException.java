...
public final class EventDispatchingException extends RuntimeException {
    ...
    public static EventDispatchingException eventDispatchingException(final Throwable cause) {
        validateNotNull(cause, "cause");
        return new EventDispatchingException(cause);
    }
}
