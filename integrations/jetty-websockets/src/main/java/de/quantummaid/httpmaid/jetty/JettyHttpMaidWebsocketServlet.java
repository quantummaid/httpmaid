...
import static de.quantummaid.httpmaid.jetty.JettyHttpMaidWebsocketCreator.fakeLambdaWebsocketCreator;
...
public final class JettyHttpMaidWebsocketServlet extends WebSocketServlet {
    ...
    public static JettyHttpMaidWebsocketServlet jettyHttpMaidWebsocketServlet(final HttpMaid httpMaid) {
    ...
    public void configure(final WebSocketServletFactory webSocketServletFactory) {
        webSocketServletFactory.setCreator(fakeLambdaWebsocketCreator(httpMaid));
    }
