...
public final class WebSocketNotFoundException extends RuntimeException {
    ...
    private WebSocketNotFoundException(final String message) {
        super(message);
    }

    public static WebSocketNotFoundException webSocketNotFoundException(final WebSocketId webSocketId) {
