...
public final class WebSocketMapping {
    ...
    public static WebSocketMapping webSocketMapping(final MetaDataEntriesToSave metaDataEntriesToSave,
                                                    final PathTemplate pathTemplate) {
        validateNotNull(metaDataEntriesToSave, "metaDataEntriesToSave");
